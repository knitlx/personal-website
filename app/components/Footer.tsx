        ...
        <div className="footer-top relative flex flex-col sm:flex-row items-center justify-between pb-2 border-b border-b-[rgba(255,255,255,0.1)] gap-3">
          <div className="footer-brand max-w-[280px] w-auto text-center sm:text-left order-1 mx-auto sm:mx-0">
            <p className="footer-tagline text-[#b0b0b0] text-sm sm:text-base">
              <span className="whitespace-nowrap">AI-системы и</span>
              <br className="hidden sm:inline" />{" "}
              <span className="whitespace-nowrap">автоматизация процессов</span>
            </p>
          </div>

          <div className="footer-links absolute left-1/2 -translate-x-1/2 hidden md:block order-2">
          ...
          <div className="footer-social hidden md:flex w-full md:w-auto justify-center md:justify-end order-3">
            <div className="social-icons flex gap-4 items-center">
              {/* Icons on tablet/desktop */}
              <a
                href="https://t.me/knitlx"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link text-[#b0b0b0] transition-colors duration-300 ease-in-out hover:text-[#00C4FF] flex-shrink-0"
                aria-label="Telegram"
              >
          ...
          {/* Mobile links - show on screens smaller than md */}
          <div className="md:hidden w-full order-2">
            <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-4 text-sm">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#b0b0b0] transition-colors duration-300 ease-in-out hover:text-[#00C4FF]"
                aria-label="Telegram"
              >
