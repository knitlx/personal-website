      ...
      >
        {visibleCount < projects.length && (
          <button
            ...
            className="inline-flex items-center justify-center rounded-lg font-unbounded-fix font-medium transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer px-6 py-3 text-xs md:text-sm bg-gradient-to-r from-accent to-primary text-white hover:opacity-90"
          >
            Смотреть еще
          </button>
        )}
