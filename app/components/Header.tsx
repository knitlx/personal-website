    ...
    <div className="container flex justify-between items-center">
      ...
      <nav className="main-nav">
        <ul className="list-none flex items-center">
          ...
          <li className="ml-[25px]">
            <a href="https://t.me/knitlx" target="_blank" rel="noopener noreferrer" className="button-cta py-2.5 px-5 font-semibold text-white button-gradient rounded-lg shadow-button-cta hover:shadow-[0_6px_15px_rgba(123,104,238,0.5)] transition-all duration-300 hover:-translate-y-0.5 no-underline"><span className="inline-block translate-y-[-1px]">Обсудить проект</span></a>
          </li>
        </ul>
      </nav>
    </div>
