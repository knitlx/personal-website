...
const servicesData = [
  {
    ...
    description:
      "Проектирую и внедряю автоматизации, которые снимают ручную работу и упрощают бизнес-процессы.",
    when: [
  ...
  },
  {
    ...
    description:
      "Навожу порядок в информации и процессах: от систематизации и хранения до создания баз знаний и документации.",
    when: [
  ...
  },
  {
    ...
    what: [
      ...
      "помогаю с приоритизацией задач",
    ],
  ...
  return (
    <div className="bg-transparent py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center mb-12 sm:mb-16">
        ...
        <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-[2.75rem] font-unbounded-fix">
