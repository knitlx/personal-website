...
updateDate: '2026-02-22T09:15:00.094Z'
...
— почему агентные IDE не используют skills автоматически — почему они не понимают собственную архитектуру — и как настроить skills, чтобы они действительно работали.
...
В качестве основы я использовала архитектуру из проекта Superpowers: https://github.com/obra/superpowers 
...
После добавления такого правила поведение меняется. Агент больше не «решает», учитывать инструкции или нет. Он обязан проверить их перед любым ответом. Это работает в OpenCode, Cursor и Claude Code — везде, где можно добавить стартовый скилл или системную инструкцию.

Это и есть реальный принцип работы agent-IDE: модель не понимает архитектуру. Она следует тексту, который ей предоставлен.
